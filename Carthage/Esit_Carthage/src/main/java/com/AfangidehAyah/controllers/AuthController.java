...
public class AuthController {
	...
	// Instantiate a Logger object so that we can achieve logging (you can either do
	// logging OR testing for P1)
	public static Logger log = LogManager.getLogger();

	// we need an AuthService, remember the Service layer sits between the
	...
	// we need a loginHandler to take in Login Data, make a LoginDTO, and send it to
	// the service
	// if login is successful, the service sends back a String which we use in our
	// return (ctx.result())
	...
	// login will be a POST request, check insertEmployeeHandler if any of this
	// syntax eludes you
